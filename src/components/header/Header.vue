...
<template>
  <header class=" h-[75px] w-full px-5 md:px-12">
      <nav class="h-full flex items-center justify-between relative">
        <h3 class="logo text-lg font-[600]">Luke&Aira</h3>

        <div @click="navBarClicked()" class="navbar-toggle absolute right-0 top-[50%] translate-y-[-50%] cursor-pointer block md:hidden z-10">
